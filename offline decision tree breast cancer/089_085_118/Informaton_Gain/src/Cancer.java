...
public class Cancer {
    ...
    public static void main(String[] args) {
    	...
    	for(loop = 0; loop <100; loop++)
		{
		  //System.out.println(performence[loop][0]+" "+performence[loop][1]+" "+performence[loop][2]+" "+performence[loop][3]);
		}
		
		try{
			FileWriter f_stream = new FileWriter("table.txt");
			BufferedWriter out = new BufferedWriter(f_stream);
			out.write("This is for information gain\n");
