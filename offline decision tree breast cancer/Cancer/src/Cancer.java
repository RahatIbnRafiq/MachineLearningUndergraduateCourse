...
public class Cancer {
	...
	public int Maxgain(double [][]gain)
	{
		...
		for(i=0;i<9;i++)
		{
			//System.out.println(gain[i][0]+" "+gain[i][1]);
    ...
    public static void main(String[] args) {
		...
		//System.out.println(Test_positive+" "+Test_negative+" "+expected_Positive+" "+expected_Negative);
		...
		//System.out.println("accuracy is "+accuracy+"  "+precision+" "+recall+" "+G_Near);
